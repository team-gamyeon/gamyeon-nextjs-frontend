...
export function AnalysingCard() {
  return (
    <Link href="/interview" onClick={(e) => e.stopPropagation()} className="flex h-full flex-col items-center justify-center gap-2 p-3 text-center @[180px]:gap-3 @[180px]:p-4 @[220px]:gap-4 @[220px]:p-5 @[280px]:gap-6 @[280px]:p-6">
