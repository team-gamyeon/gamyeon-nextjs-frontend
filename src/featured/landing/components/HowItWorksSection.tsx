...
const steps: Step[] = [
  {
    step: '01',
    title: '이력서 업로드',
    description: '이력서 또는 포트폴리오를 업로드하면 AI가 내용을 분석합니다.',
  },
  {
    step: '02',
    title: '면접 시뮬레이션',
    description: '실전과 동일한 환경에서 AI 면접관과 모의 면접을 진행합니다.',
  },
  {
    step: '03',
    title: '결과 리포트 확인',
    description: 'AI 분석 리포트를 통해 개선점을 파악하고 실력을 향상시킵니다.',
  },
]
        ...
        <div className="grid gap-8 md:grid-cols-3">
          {steps.map((step, i) => (
            ...
            >
              ...
              {i < steps.length - 1 && (
                <div className="bg-border absolute top-8 left-[calc(50%+40px)] hidden h-px w-[calc(100%-80px)] md:block" />
              )}
            </motion.div>
          ))}
        </div>
