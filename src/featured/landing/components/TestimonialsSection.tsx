...
const testimonials: Testimonial[] = [
  { name: "김서연", role: "프론트엔드 개발자 취준생", content: "실제 면접에서 받은 질문과 거의 비슷해서 놀랐어요. 덕분에 자신감 있게 면접에 임할 수 있었습니다.", rating: 5 },
  { name: "이준호", role: "마케팅 직무 지원자", content: "시간 관리 피드백이 정말 유용했어요. 답변 시간을 줄이는 연습을 할 수 있었습니다.", rating: 5 },
  { name: "박지민", role: "데이터 분석가 취준생", content: "혼자 준비하면 놓치기 쉬운 부분을 AI가 정확히 짚어줘서 큰 도움이 됐어요.", rating: 5 },
];
