 ...
 */
export async function getReportDetail(intvId: number): Promise<ApiResponse<ReportDetailData>> {
 ...
 */
export async function deleteReport(intvId: number): Promise<ApiResponse<null>> {
  // 명세서의 /api/v1/report/delete/{intvId} 반영
