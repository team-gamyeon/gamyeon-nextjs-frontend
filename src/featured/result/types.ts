...
export const MOCK_FEEDBACKS: FeedbackItem[] = [
  {
    ...
    score: 85,
    feedback: "핵심 역량을 잘 정리하여 전달했습니다. 지원 동기와 연결하여 더 구체적으로 말씀하시면 좋겠습니다.",
    tags: ["좋은 구조", "동기 보완 필요"],
  },
  {
    question: "가장 어려웠던 기술적 도전은?",
    score: 72,
    feedback: "문제 상황 설명은 잘했으나, 해결 과정을 STAR 기법으로 구조화하면 더 설득력이 높아집니다.",
    tags: ["구체적 사례", "STAR 기법 활용 권장"],
  },
  {
    question: "팀 내 의견 충돌 대처 방법은?",
    score: 68,
    feedback: "협업 경험이 부족한 느낌입니다. 구체적인 갈등 사례와 본인의 역할을 더 명확히 설명해주세요.",
    tags: ["사례 부족", "역할 명확화 필요"],
  },
  {
    question: "5년 후 커리어 목표는?",
    score: 78,
    feedback: "비전이 명확하고 현실적입니다. 회사의 성장과 연결 지으면 더 좋은 인상을 줄 수 있습니다.",
